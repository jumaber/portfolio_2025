  ...
  return (
    <div className="flex flex-col md:flex-row items-start gap-4 justify-between bg-white p-2 rounded-md w-full">
      ...
      <div className="flex items-center gap-4">
        {/* Placeholder Image */}
        <img src={image} className="w-12 h-12 border-1 border-neutral-200 rounded-lg"/>
        {/* Title */}
      ...
      <div className="flex items-center gap-4">
        <ButtonDrag />
        <Switch />
        <ButtonSmall text="Edit" image={null} />
        <ButtonSmall text="Visit" image="/src/assets/link.svg" />
      </div>
    </div>
  );
}
